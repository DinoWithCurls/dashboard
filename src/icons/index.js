const TransactionIcon = () => {
  return (
    <div className="h-5 w-5">
      <img src={require("./transaction_icon.png")} alt="trnsicon" />
    </div>
  );
};
...
const TotalTransactionIcon = () => {
  return (
    <div className="h-5 w-5">
      <img src={require("./Transaction.png")} alt="tottrns" />
    </div>
  );
};
...
const ScheduleIcon = () => {
  return (
    <div className="h-5 w-5">
      <img src={require("./schedule_icon.png")} alt="schicon" />
    </div>
  );
};
